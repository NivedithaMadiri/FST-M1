...
select o.order_no,o.order_date,o.purchase_amount,c.customer_name,sm.salesman_name  from salesman sm, customers c, orders o 
where sm.salesman_id=c.salesman_id and c.salesman_id=o.salesman_id and sm.salesman_id=o.salesman_id and c.customer_id=3007;
